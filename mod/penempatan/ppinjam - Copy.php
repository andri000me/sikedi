...
if($_GET['act']=="tambah"){
	...
	$tik = "P.".$ntgls.".".getANum("kode","pinjam","1",9);
	//echo $tid."<br>".$gn;
?>
...
<div class="widget-main">
	...
	<form method="POST" enctype="multipart/form-data" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<select class="span3" name="peminjam" id="peminjam" placeholder="Pilih Nama">
					<?php
...
?>
	...
	<thead>
	    ...
	    <th class="center" width="120px">Peminjam</th>
	    <th class="center" width="80px">Inventaris</th>
	    <th class="center" width="60px">Tgl Pinjam</th>
	    <th class="center" width="80px">Rencana Kembali</th>
	    <th class="center"width="60px">Keperluan</th>
	    <th class="center" width="60px">Status</th>
	    <th class="center" width="60px">Tgl Kembali</th>
	...
	<tbody>
	 <?php
        $no=0;
	    $qry = mysql_query("SELECT * FROM pinjam ORDER BY id DESC");
		...
		$nama = getValue("nama","ms_pegawai","pNip='$d[peminjam]'");
	      ...
	      <td class='center'>";
      		if (!empty($d['tglk'])) {
      				$print =
      				"<form action='cetak/reportpj.php?r=$d[pTiket]' method='POST' target='_blank'>
