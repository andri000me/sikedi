...
<div class="widget-main">
	...
	<?php
		if (isset($_POST['simpan'])){
			...
			$q = mysql_query("INSERT INTO kendi (kdkab,bkode,bjenis,bmerek,btipe,no_mesin,no_rangka,no_plat,no_bpkb,bpemegang,bkondisi,thn_per,harga_per,ket,foto,onCreate)
	      											VALUES('$kd','$bid','$_POST[bjenis]','$_POST[bmerek]',
	      													 '$_POST[btipe]','$_POST[no_mesin]','$_POST[no_rangka]','$_POST[no_plat]','$_POST[no_bpkb]','$_POST[bpemegang]','$_POST[bkondisi]','$_POST[thn_per]','$_POST[harga_per]','$_POST[ket]','$foto',NOW())");
	        }else{
