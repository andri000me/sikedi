...
if($_GET['act']=="tambah"){
	...
	$bid = "KD.$kd.".getANum("bkode","kendi","1",8);
	//echo $bid."<br>".$gn;
?>
...
<div class="widget-main">
	...
	<form method="POST" enctype="multipart/form-data" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<select class="span5 chosen-select" name="bjenis" id="bjenis" placeholder="Pilih Jenis">
		...
		<div class="control-group">
			...
			<div class="controls">
				<select class="span5 chosen-select" name="bmerek" id="bmerek" placeholder="Pilih Merek">
		...
		<div class="control-group">
			...
			<div class="controls">
				<select class="span5 chosen-select" name="btipe" id="btipe" placeholder="Pilih Tipe">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input class="input-small" type="text" id="thn_per" name="thn_per" value="<?php echo $e['thn_per'];?>" required>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input class="input-xlarge" type="text" id="harga_per" name="harga_per" value="<?php echo $e['harga_per'];?>" >
			</div>
		</div>
		...
		if (isset($_POST['simpan'])){
			$q = mysql_query("INSERT INTO kendi (kdkab,bkode,bjenis,bmerek,btipe,no_mesin,no_rangka,no_plat,no_bpkb,bpemegang,bkondisi,thn_per,harga_per,ket,onCreate)
	      											VALUES('$kd','$bid','$_POST[bjenis]','$_POST[bmerek]',
	      													 '$_POST[btipe]','$_POST[no_mesin]','$_POST[no_rangka]','$_POST[no_plat]','$_POST[no_bpkb]','$_POST[bpemegang]','$_POST[bkondisi]','$_POST[thn_per]','$_POST[harga_per]','$_POST[ket]',NOW())");
...
<div class="widget-main">
	<!-- FORM -->
		...
		<div class="control-group">
			<label class="control-label" for="bjenis">Jenis</label>
			<div class="controls">
				<select class="span3" name="bjenis" id="bjenis" placeholder="Pilih Jenis">
				<option>-- Pilih Jenis --</option>
					<?php
	    ...
	    <tr>
	      ...
	      <td class='center'>
		    ...
		    if ($kd!=$d['kdkab']) {
                ...
                echo "
                <a href='?page=dkendi&j=$d[idjen]&m=$d[idmerek]&t=$d[rTipe]&kd=$kd' class='tooltip-success' data-rel='tooltip' data-original-title='Detail Kenderaan Dinas'>
