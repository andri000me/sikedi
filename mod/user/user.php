...
<div class="widget-main">
	...
	<form method="POST" enctype="multipart/form-data" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<select class="span2 chosen-select" name="kdkab" id="kdkab">
		...
		<div class="control-group">
			...
			<div class="controls">
				<select class="span2 chosen-select" name="lvl" id="lvl">
				<option>-- Pilih Level --</option>
					<?php
						$qsp = mysql_query("SELECT * FROM _level ORDER BY id ASC");
						while ($s=mysql_fetch_array($qsp)) {
							if ($e['ulevel']==$s['id']){
			...
			<div class="controls">
				<select class="span2 chosen-select" name="kdkab" id="kdkab">
					...
					if ($kodelvl =='1200') {
						...
						$qsp = mysql_query("SELECT * FROM kdkab WHERE id_kabkot ='$kodelvl'");
...
?>
	...
	<tbody>
	 <?php
	    $qry = mysql_query("SELECT * FROM user WHERE KDKAB='$kodelvl' ORDER BY onCreate DESC");
