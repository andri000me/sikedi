...
?>
	...
	$dt = getData("*,COUNT(bId) AS bJlh","barang","bId='$iid' GROUP BY bjenis");
	?>
	<div class="page-header">
		<div class="alert alert-info">
			<b>Kode Barang : </b><?php echo $dt['bkode'];?><br>
			<b>Nama Barang : </b><?php echo $dt['bnama'];?><br>		
			<b>Merek : </b><?php echo $dt['bmerek'];?><br>	
		 ...
		 <?php
		   ...
		   $qry = mysql_query($qrt);
			while ($d = mysql_fetch_array($qry)){
		      ...
		      <td class='center'>
	         	<a href='?page=hrepair&did=$d[bkode]' class='tooltip-primary' data-rel='tooltip' data-original-title='History Perbaikan'>
