...
?>
	...
	<tbody>
	 <?php
	    ...
	    $qry = mysql_query("SELECT a.*,b.pTglS,b.pKondisi,b.pKet FROM perbaikan a LEFT JOIN sperbaikan b ON a.pTiket=b.pTiket  ORDER BY a.pTiket DESC");
	    ...
	    $tglp = getTglIndo($d['pTgl']);
      	...
      	if (!empty($d['pTglS'])){
			...
			//$report = "<a href='cetak/reportp.php?id=$d[pTiket]'>Cetak Form</a>";
      	}
