<div class="row-fluid">
	<div class="span12">
		<div class="page-header">
			<h1>INPUT PERAWATAN KENDERAAN DINAS BPS (UMUM)</h1>
		</div>
		<?php
		$kd     = $_SESSION['dpkode'];
		...
		if($_GET['act']=="tambah"){
			...
			echo "
			<div class='table-header'>INPUT PERAWATAN KENDERAAN DINAS BPS $nmkab</div>
			<div class='row-fluid'>
			...
			while ($d = mysql_fetch_array($qry)){
				...
				<a href='?page=rkendi2&id=$d[bId]&kd=$kd' class='tooltip-success' data-rel='tooltip' data-original-title='Detail Perawatan'>
