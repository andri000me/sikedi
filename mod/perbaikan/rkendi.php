...
$t = mysql_fetch_array(mysql_query("SELECT sum(biaya) as total FROM rep_kendi WHERE bkode='$e[bId]' AND YEAR(tglrep)='2019' "));
...
?>
	...
	<div class="table-header">
	   <?php echo $merek;?> - <?php echo $tipe;?> <b><?php echo $e['no_plat'];?>&nbsp;&nbsp;&nbsp;&nbsp; &raquo [SISA PAGU : Rp <?php echo $bi_for ?>,-]</b>&nbsp;&nbsp;a.n : <?php echo $uname ?> <?php echo $thn ?>
