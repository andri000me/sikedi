...
<div class="widget-main">
	...
	<?php
		if (isset($_POST['simpan'])){
			...
			$q1 = mysql_query("INSERT INTO rep_kendi (bkode,tglrep,rekrep,bbm,km,biaya,detrep,onCreate)
	      											VALUES('$e[bId]','$_POST[tglrep]','$_POST[rekrep]','$_POST[bbm]','$_POST[km]','$_POST[biaya]','$_POST[detrep]',NOW())");	
...
?>
	...
	<div class="table-header">
	   <?php echo $jenis;?> : <?php echo $merek;?> - <?php echo $tipe;?> <b><?php echo $e['no_plat'];?>&nbsp;&nbsp;&nbsp;&nbsp; &raquo [SISA PAGU : Rp <?php echo $bi_for ?>,-]</b>
	...
	<thead>
	    ...
	    <th class="center" width="180px">Uraian</th>
