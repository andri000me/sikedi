...
?>
	...
	if ($kd=='1200' or $kd=='1000') {
		...
		<form class='form-search' method='GET'>
			<input type='hidden' name='page' value='mruang'>
			...
			<a href='?page=mruang' type='button' class='btn btn-primary btn-small'>
				Reset
	...
	if (!empty($_GET[kkb])) {
	echo "
	DATA MASTER RUANG MENURUT BPS $nmkab";
	} else {
	echo "
	DATA MASTER RUANG MENURUT BPS PROVINSI SUMATERA UTARA";
	}
	echo "
