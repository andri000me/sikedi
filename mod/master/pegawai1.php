...
<div class="widget-main">
	...
	<form method="POST" enctype="multipart/form-data" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input class="input-large" type="text" id="hp" name="hp" value="<?php echo $e['hp'];?>" >
			</div>
		</div>
	...
	<?php
		if (isset($_POST['simpan'])){
		  	...
		  	$q = mysql_query("INSERT INTO ms_pegawai (pNip,kdkab,nama,email,niplama,gol,jk,jb,lokasi,hp,rk,kaos,onCreate)
		  											VALUES('$_POST[pNip]','$_POST[kdkab]','$_POST[nama]','$_POST[email]','$_POST[niplama]','$_POST[pkt]','$_POST[jk]','$_POST[jb]','$_POST[lokasi]','$_POST[hp]','$_POST[rk]','$_POST[kaos]',NOW())
		                    ");
			if ($q){
			echo "<script>
...
<div class="widget-main">
	...
	<form method="POST" enctype="multipart/form-data" class="form-horizontal">
		...
		<!-- <div class="control-group">
			<label class="control-label" for="kaos">Ukuran Kaos</label>
			<div class="controls">
				<select class="span2 chosen-select" name="kaos" id="kaos" placeholder="Ukuran Kaos">
					<option>-- Pilih Ukuran Kaos --</option>
					<?php
