...
// -- FUNGSI UPLOAD FOTO USER --//
function UploadKendi($fupload_name){
  $vdir_upload = "foto_kendi/";                    //direktori penyimpanan gambar
...
// -- FUNGSI UPLOAD FOTO KENDI --//

function UploadKantor($fupload_name){
  $vdir_upload = "foto_kantor/";                    //direktori penyimpanan gambar
