...
if (empty($_SESSION['dpId'])){
	...
	$content .= "
	    		...
	    		$qry = mysql_query("SELECT bkode,tglrep,rekrep,bbm,km,biaya FROM rep_kendi WHERE $tterm AND MONTH(tglrep) between $bln1 AND $bln2 AND bkode='$kdk'");			
	    		$biaya =0;
	    		$tbbm =0;
...
*/				
				...
				<tr>
					<td style='border:0px solid #A9A9A9; padding: 4px;' width='240' align='left'>
						Mengetahui :
						<br>
						Kasubbag Tata Usaha/Kasubbag Umum
						<br><br><br>								
						<u>$tu</u><br>
						$niptu
					</td>
