...
if (emty($_SESSION['dId'])){
	...
	$kd      = $_SESSION['dkode'];
    $r       = $_GET['r'];
    $kkb     = getValue("kdkab","erbaikan","Tiket='$r'");
	...
	$content = "
			    ...
			    $emilik = strtouer(getValue("nama","ms_egawai","Ni='$d[user]'"));
			    ...
			    $tiket  =$d[Inv];
      			$ruang  = getValue("Ruang","enematan","Inv='$d[Inv]'");
	   			...
	   			$lantai = getValue("rJenis","ms_ruangan","rKode='$ruang'");
