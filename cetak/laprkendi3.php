...
if (empty($_SESSION['dpId'])){
	...
	$e = mysql_fetch_array(mysql_query("SELECT * FROM kendi WHERE bId='$bId'"));
	...
	$peme  = strtoupper(getValue("nama","ms_pegawai","pNip='$e[bpemegang]'"));		
	...
	$content = "
				...
				<tr valign='middle'>						
						...
						<td align='center'>
							...
							Kendaraan Bermotor $jenis - $merek [$tipe] No Polisi : <b>$e[no_plat]</b><br>
							atas nama : <b>$peme</b>
						</td>
					</tr>
				</table>
	...
	$content .= "
				...
				<tr>
					...
					<th align='center' width='220' style='border:0.5px solid #000; background-color: $_CONFIG[syscolor]; padding: 4px;'>Uraian</th>
				...
				$d   = mysql_query("SELECT * FROM kendi WHERE bId='$bId'");

	    		$qry = mysql_query("SELECT bkode,tglrep,rekrep,bbm,km,biaya FROM rep_kendi WHERE $tterm AND MONTH(tglrep) between $bln1 AND $bln2 AND bkode='$bId'");				
	    		$biaya =0;
	    		$tbbm =0;
	    		...
	    		$pemegang = getValue("nama","ms_pegawai","pNip='$d[bpemegang]'");
					...
					"<tr>				
						...
						<td style='border:0.5px solid #000; padding: 4px;' align='center'>$bkm</td>
						<td style='border:0.5px solid #000; padding: 4px;' align='center'>$km</td>
...
*/				
				...
				<tr>
					...
					<td style='border:0.5px solid #000; padding: 4px;' align='center'>$tbbm</td>
					<td style='border:0.5px solid #000; padding: 4px;' align='center'>-</td>
					<td style='border:0.5px solid #000; padding: 4px;' align='center'>$f_tbiaya</td>	
				</tr>
